...
class I18Nv2_Charset
{
     ...
     * @param   string      $charset
     */
    function nameOf($charset)
    {
        $charset = I18Nv2_Charset::standardize($charset);
        if (isset($GLOBALS['_I18Nv2_Charset_Names'][$charset])) {
            return $GLOBALS['_I18Nv2_Charset_Names'][$charset];
        }
        return I18Nv2_Charset::forAlias($charset);
    }
    ...
    function forAlias($alias)
    {
        ...
        foreach (array_keys($GLOBALS['_I18Nv2_Charset_Aliases']) as $a) {
            if (in_array($name, $GLOBALS['_I18Nv2_Charset_Aliases'][$a])) {
                return $GLOBALS['_I18Nv2_Charset_Names'][$a];
            }
        }
        return false;
    }
